...
public class QueryDatalistAction extends ActionSupport {
	...
	public String listDatalist() {
		...
		List<Datalist> list = dao.getDatalistListByPage(intPage, number);// 每页的数据，放入list
		Map<String, Object> jsonMap = new HashMap<String, Object>();// 定义map
		jsonMap.put("total", dao.getTotalDatalist());// total�?存放总记录数，必须的
